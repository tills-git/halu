...
class CustomerSelection_model():
    ...
    def __init__(self, mvclog, mvclogname, database, sqldict, requestdict):
        try:
            ...
            self.mvclog.debug(self.mvclogname, 'CustomerSelection_model init start')
            ...
            self.mvclog.error(self.mvclogname, f'CustomerSelection_model init exception message : {e}')

        finally:
            self.mvclog.debug(self.mvclogname, 'CustomerSelection_model init end')

    def getOffsetLineOfCustomerSelection(self, idName1, idName2):
        """
        ...
        result : str
            'OK' 固定
        """
        self.mvclog.debug(self.mvclogname, 'CustomerSelection_model getOffsetLine start')
        ...
        self.mvclog.debug(self.mvclogname, 'CustomerSelection_model getOffsetLine end')
        return status
