...
class BatchList_model():
    ...
    def getOffsetLineOfBatchList(self, idName1, idName2):
        """
        ...
        result : str
            'OK' 固定
        """
        self.mvclog.debug(self.mvclogname, 'BatchList_model getOffsetLine start')
        ...
        self.mvclog.debug(self.mvclogname, 'BatchList_model getOffsetLine end')
        return status
